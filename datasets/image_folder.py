...
class ImageFolder(Dataset):
    ...
    def img_process(self, file):
        if self.mask:
            return Image.open(file).convert('1')
        else:
...
#         self.filenames = np.genfromtxt(path, dtype='str')
...
#     def __init__(self, root_path_1, root_path_2, img_path_1, img_path_2, **kwargs):
#         self.dataset_1 = ImageFolder(root_path_1, img_path_1, **kwargs)
#         self.dataset_2 = ImageFolder(root_path_2, img_path_2, **kwargs, mask=True)
